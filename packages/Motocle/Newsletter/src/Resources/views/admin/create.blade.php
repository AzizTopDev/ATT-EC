...
@section('page_title')
    {{ __('newsletter::app.cms.newsletter.page-title.create') }}
@stop

@section('content')
    <div class="content cms-newsletter">
        <form method="POST" id="newsletter-submit" action="{{ route('admin.motocle.cms.dm.store') }}" @submit.prevent="onSubmit">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        ...
                        {{ __('newsletter::app.cms.newsletter.newsletter') }}
                    </h1>
                </div>
                ...
                <div class="form-container mt-25">
                    ...
                    <div slot="body">
                        <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                            ...
                            <input type="text" class="control" name="name" v-validate="'required'" maxlength="100" tabindex="1" value="{{ old('name') }}" data-vv-as="&quot;{{ __('newsletter::app.cms.newsletter.template-name') }}&quot;">
                        ...
                        <div class="control-group" :class="[errors.has('subject') ? 'has-error' : '']">
                            ...
                            <input type="text" class="control" name="subject" v-validate="'required'" maxlength="100" tabindex="2" value="{{ old('subject') }}" data-vv-as="&quot;{{ __('newsletter::app.cms.newsletter.subject') }}&quot;">
                        ...
                        <div class="control-group" :class="[errors.has('content') ? 'has-error' : '']">
                            ...
                            <textarea type="text" class="control" id="content" name="content" tabindex="4" v-validate="'required'" data-vv-as="&quot;{{ __('newsletter::app.cms.newsletter.mail_content') }}&quot;">{{ old('content') }}</textarea>
                        ...
                        <div class="page-action">
                            <button type="submit" name="action" value="send" tabindex="5" class="btn btn-lg btn-primary clicked-action">
