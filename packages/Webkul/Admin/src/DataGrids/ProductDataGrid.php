...
class ProductDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('product_flat')
            ...
            ->select(
                ...
                'categories.display_mode as category',
                'product_flat.new as new',
                'product_flat.featured as featured',
    ...
    public function addColumns()
    {
        ...
        $this->addColumn([
            'index'      => 'new',
            'label'      => trans('admin::app.datagrid.new'),
            'type'       => 'boolean',
            'sortable'   => true,
            'searchable' => false,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'featured',
            'label'      => trans('admin::app.datagrid.featured'),
            'type'       => 'featured',
            'sortable'   => true,
            'searchable' => false,
            'filterable' => true,
