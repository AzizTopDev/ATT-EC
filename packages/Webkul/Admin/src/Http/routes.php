...
Route::group(['middleware' => ['web']], function () {
    ...
    // Login Routes
    Route::get('/mtclsecuredlogin', 'Webkul\User\Http\Controllers\SessionController@create')->defaults('_config', [
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/reset-password/{token}/{email}', 'Webkul\User\Http\Controllers\ResetPasswordController@create')->defaults('_config', [
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('cms')->group(function () {
                ...
                Route::post('/tinymce/upload-image/{type}', 'Webkul\Admin\Http\Controllers\ImageUploadController@tinyMceUpload')->name('admin.tinymce.image.upload');
            });

            //shop notification
            Route::prefix('shop-notification')->group(function () {
                Route::get('/', 'Webkul\CMS\Http\Controllers\Shop\ShopNotificationController@index')->defaults('_config', [
                    'view' => 'admin::shop-notification.index'
                ])->name('admin.shop-notification.index');

                Route::get('/create', 'Webkul\CMS\Http\Controllers\Shop\ShopNotificationController@create')->defaults('_config', [
                    'view' => 'admin::shop-notification.create'
                ])->name('admin.shop-notification.create');

                Route::post('/save', 'Webkul\CMS\Http\Controllers\Shop\ShopNotificationController@save')->defaults('_config', [
                    'redirect' => 'admin.shop-notification.index'
                ])->name('admin.shop-notification.save');

                Route::get('/edit/{id}', 'Webkul\CMS\Http\Controllers\Shop\ShopNotificationController@edit')->defaults('_config', [
                    'view' => 'admin::shop-notification.edit'
                ])->name('admin.shop-notification.edit');

                Route::post('/update/{id}', 'Webkul\CMS\Http\Controllers\Shop\ShopNotificationController@update')->defaults('_config', [
                    'redirect' => 'admin.shop-notification.index'
                ])->name('admin.cms.shop-notification.update');

                Route::post('/delete/{id}', 'Webkul\CMS\Http\Controllers\Shop\ShopNotificationController@delete')->defaults('_config', [
                    'redirect' => 'admin.shop-notification.index'
                ])->name('admin.shop-notification.delete');
            });
