...
@section('page_title')
    {{ __('admin::app.cms.shop-notification.edit-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.cms.shop-notification.update', $notification->id) }}" @submit.prevent="onSubmit">
            ...
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('admin::app.cms.shop-notification.update-btn') }}
                    </button>
                </div>
            </div>
                ...
                <div class="form-container">
                    ...
                    <div slot="body">
                        <div class="control-group" :class="[errors.has('admin_name') ? 'has-error' : '']">
                            ...
                            <input type="text" class="control" name="admin_name" v-validate="'required'" value="{{ $notification->admin_name }}" data-vv-as="&quot;{{ __('admin::app.cms.shop-notification.admin-name') }}&quot;">

                            <span class="control-error" v-if="errors.has('admin_name')">@{{ errors.first('admin_name') }}</span>
                        </div>

                        <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                            <label for="title" class="required">{{ __('admin::app.cms.pages.title') }}</label>

                            <input type="text" class="control" name="title" v-validate="'required'" value="{{ $notification->title }}" data-vv-as="&quot;{{ __('admin::app.cms.shop-notification.title') }}&quot;">
                        ...
                        <div class="control-group" :class="[errors.has('content') ? 'has-error' : '']">
                            ...
                            <textarea type="text" class="control" id="content" name="content" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.cms.shop-notification.content') }}&quot;">
                        ...
                        <div class="control-group" :class="[errors.has('display_flag') ? 'has-error' : '']">
                            <label>
                                ...
                                <label class="switch" style="margin-left: 15px">
                                    <input type="checkbox" name="display-flag" @if ($notification->display_flag == 1) checked @endif @if (!$toggle_flag) disabled @endif>
