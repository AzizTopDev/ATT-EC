                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.attributes.label') }}'" :active="true">
                        <div slot="body">
                            ...
                            @foreach (app('Webkul\Core\Repositories\LocaleRepository')->all() as $locale)
                                ...
                                <div class="control-group">
                                    <label for="locale-{{ $locale->code }}">{{ $locale->name }}</label>
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.attributes.configuration') }}'" :active="true">
                        <div slot="body">
                            ...
                            <input type="hidden" id="value_per_locale" name="value_per_locale" value="0" />
                            ...
                            <input type="hidden" id="use_in_flat" name="use_in_flat" value="1" />
                            ...
                            <input type="hidden" id="is_comparable" name="is_comparable" value="0" />
                            ...
                            @foreach (app('Webkul\Core\Repositories\LocaleRepository')->all() as $locale)
                                <td>
                                    <div class="control-group" :class="[errors.has(localeInputName(row, '{{ $locale->code }}')) ? 'has-error' : '']">
                                        <input type="text" v-validate="getOptionValidation(row, '{{ $locale->code }}')"  v-model="row['{{ $locale->code }}']" :name="localeInputName(row, '{{ $locale->code }}')" class="control" data-vv-as="&quot;{{ $locale->name }}&quot;"/>
