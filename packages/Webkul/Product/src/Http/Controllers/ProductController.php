...
class ProductController extends Controller
{
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('admin::app.response.create-success', ['name' => '商品']));
    ...
    public function update(ProductForm $request, $id)
    {
        ...
        session()->flash('success', trans('admin::app.response.update-success', ['name' => '商品']));
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            session()->flash('success', trans('admin::app.response.delete-success', ['name' => '商品']));

            return response()->json(['message' => true], 200);
        } catch (\Exception $e) {
            report($e);

            session()->flash('error', trans('admin::app.response.delete-failed', ['name' => '商品']));
        }
