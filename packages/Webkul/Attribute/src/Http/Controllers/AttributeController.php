...
class AttributeController extends Controller
{
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('admin::app.response.create-success', ['name' => '属性']));
    ...
    public function update($id)
    {
        ...
        session()->flash('success', trans('admin::app.response.update-success', ['name' => '属性']));
    ...
    public function destroy($id)
    {
        ...
        if (! $attribute->is_user_defined) {
            session()->flash('error', trans('admin::app.response.user-define-error', ['name' => '属性']));
        } else {
            try {
                $this->attributeRepository->delete($id);

                session()->flash('success', trans('admin::app.response.delete-success', ['name' => '属性']));

                return response()->json(['message' => true], 200);
            } catch(\Exception $e) {
                session()->flash('error', trans('admin::app.response.delete-failed', ['name' => '属性']));
            }
        }
