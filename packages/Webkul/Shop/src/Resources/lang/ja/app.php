...
return [
    ...
    'mail' => [
        ...
        'forget-password' => [
            ...
            'dear' => ':name 様',
            'info' => 'パスワードを再発行についてお知らせいたします。下記のボタンをクリックしていただき、新しいパスワードの設定をお願いいたします。',
            'reset-password' => 'このパスワード再設定のリンクは60分で期限切れになります。ボタンがうまく動作しない場合は下記のURLをコピーしてご利用ください。',
            'final-summary' => '本メールは、配信専用のアドレスで配信されています。このメールにご返信 いただいても、内容の確認およびご返答はできません。ご了承ください。',
            'thanks' => '当サイトへの登録をした覚えがないのに、このメールを受け取られた方は、お手数ではございますがこのまま破棄をお願い致します。'
        ],
        'customer' => [
            'new' => [
